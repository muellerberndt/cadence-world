...
const lifeByCells = {}, lifeByCortices = {}, lifeByHorizon = {}, lifeByRadius = {};
const push = (t, k, v) => (t[k] = t[k] || []).push(v);
pop.onDeath = c => { push(lifeByCells, c.brain.cellsTotal, c.age); push(lifeByCortices, c.brain.cortices.length, c.age); push(lifeByHorizon, c.brain.horizon, c.age); push(lifeByRadius, c.brain.r, c.age); };
...
console.log(JSON.stringify({ final: true, rules, seed, T, lifeByCells: table(lifeByCells), lifeByCortices: table(lifeByCortices), lifeByHorizon: table(lifeByHorizon), lifeByRadius: table(lifeByRadius), symbols,
